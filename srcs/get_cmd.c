...
static struct s_msh_cmd	*init_variables_and_check_some_things_on_the_input(struct s_get_cmd_list_var_norme_lol *variables, char *cmd_input)
{
...
static struct s_msh_cmd	*skip_sep_and_semicolon(char **cmd_input, struct s_msh_cmd *ll_cmd)
{
	while ( is_sep(**cmd_input) ) 
		++(*cmd_input);
...
static struct s_msh_cmd	*get_cmd_list(char *cmd_input)
{
