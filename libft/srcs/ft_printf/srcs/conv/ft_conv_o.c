...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/01/13 16:06:41 by cyfermie          #+#    #+#             */
/*   Updated: 2018/01/13 16:08:12 by cyfermie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_get_size_o(t_arg *arg, int *size_nb)
{
	...
	sz = sizeof(int);
	sz = (ft_getheight(arg) == 'H') ? (int)sizeof(char) : sz;
	sz = (ft_getheight(arg) == 'h') ? (int)sizeof(short) : sz;
	sz = (ft_getheight(arg) == 'l') ? (int)sizeof(long) : sz;
	sz = (ft_getheight(arg) == 'L') ? (int)sizeof(t_ll) : sz;
...
static void	ft_get_size_new(t_arg *arg, int size_nb, int *size_new)
{
	*size_new = size_nb;
